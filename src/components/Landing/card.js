...
// FeatureCard Component accepts an optional bgImage prop.
const FeatureCard = ({ icon, title, description, bgImage }) => {
  return (
    ...
    >
      {/* Background Image: use provided bgImage or fallback to /Calendar.png */}
      <Image
        src={bgImage || "/Calendar.png"}
        alt="Background"
        layout="fill"
        objectFit="cover"
    ...
    >
      ...
      <div className="relative z-10 flex flex-col gap-4 mt-auto">
        <div className="flex items-center gap-3">
          ...
          >
            <path
              ...
              strokeWidth="2"
              d="M4.5 12a7.5 7.5 0 0115 0m-15 0a7.5 7.5 0 1015 0"
            />
          </svg>
        ...
        <p className="text-gray-400 text-lg sm:text-xl max-w-[90%] sm:max-w-[80%] leading-relaxed">
          Discover projects, share ideas, and collaborate with individuals who share your passion.
        </p>
      </div>
    </motion.div>
  );
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 gap-6 sm:gap-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {/* Open-Source Your Vision Card with custom background image */}
            <FeatureCard
              icon={
              ...
              bgImage="/Opensource.png"
            />

            {/* Contribute & Grow Card with Contribute.jpg as background */}
            <FeatureCard
              icon={
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
